...
import pom.pageobjectclasses.plots.projectmodule.AccessAndOthersPage;
import pom.pageobjectclasses.plots.projectmodule.Home;
import pom.pageobjectclasses.plots.projectmodule.PaymentSchedule;
import pom.pageobjectclasses.plots.projectmodule.ProjectSetupPage;
import pom.pageobjectclasses.plots.projectmodule.ProjectUnitsPage;
...
public class WholeProjectCreationTestScript extends BaseClass {
 ...
 // =========================================================================
    ...
    @Test(priority = 3, dependsOnMethods = "testFullProjectCreationAndChargeOperations",
          description = "Fills all project setup steps and performs charge Edit/Delete operations.")
    public void testFullProjectUnitsPage_Plots() throws InterruptedException, TimeoutException {

    	// 2. EXECUTE PROJECT UNITS (STEP 2)
        // Initialize the ProjectUnitsPage object NOW that we are on the correct page.
        ProjectUnitsPage unitCreation = new ProjectUnitsPage(getDriver());
        
        // This method handles Block/Unit creation and clicks 'Next: Cost Setup' (moving to Step 3).
        unitCreation.createAllBlocksAndUnits(projectData.getBlocks());
        test.log(Status.INFO, "Project Units (Step 2) completed and navigated to Cost Setup.");
    	
    }
    
    
    @Test(priority = 4, dependsOnMethods = "testFullProjectUnitsPage_Plots",
            description = "Fills all project setup steps and performs charge Edit/Delete operations.")
    public void testCostSetupOperations_ApartmentPlot() throws InterruptedException, RuntimeException, TimeoutException {
    	
    	ProjectSetupPage setupPage = new ProjectSetupPage(getDriver());
    	
    	try {
    		
    	setupPage.fillCostSheetForm(projectData);
    ...
    // =========================================================================
    @Test(priority = 5, dependsOnMethods = "testCostSetupOperations_ApartmentPlot",
 ...
 // =========================================================================
    ...
    // =========================================================================
    @Test(priority = 6, dependsOnMethods = "testPaymentScheduleOperations_ApartmentPlot", // <-- FIX APPLIED HERE
